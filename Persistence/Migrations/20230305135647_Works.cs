    ...
    public partial class Works : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bridges", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BroBizzDevices_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BridgeName = table.Column<string>(type: "text", nullable: true),
                    VehicleLicensePlate = table.Column<string>(type: "text", nullable: true),
                    InvoiceId = table.Column<Guid>(type: "uuid", nullable: true),
                    BroBizzDeviceId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Trips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Trips_Bridges_BridgeName",
                        column: x => x.BridgeName,
                        principalTable: "Bridges",
                        principalColumn: "Name");
                    table.ForeignKey(
                        name: "FK_Trips_BroBizzDevices_BroBizzDeviceId",
                        column: x => x.BroBizzDeviceId,
                        principalTable: "BroBizzDevices",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BroBizzDevices_AppUserId",
                table: "BroBizzDevices",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_BridgeName",
                table: "Trips",
                column: "BridgeName");

            migrationBuilder.CreateIndex(
                name: "IX_Trips_BroBizzDeviceId",
                table: "Trips",
                column: "BroBizzDeviceId");
